package devguide.advanced.inheritance.applicationModule;
...
public class PersonModuleAMFixture {
    ...
    private PersonModuleAMFixture() {
        _am = Configuration.createRootApplicationModule("devguide.advanced.inheritance.PersonModule","PersonModuleLocal");
    }
