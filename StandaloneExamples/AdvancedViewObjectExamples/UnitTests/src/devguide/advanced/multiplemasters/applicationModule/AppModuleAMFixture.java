package devguide.advanced.multiplemasters.applicationModule;
...
public class AppModuleAMFixture {
    ...
    private AppModuleAMFixture() {
        _am = Configuration.createRootApplicationModule("devguide.advanced.multiplemasters.AppModule","AppModuleLocal");
    }
