package devguide.advanced.inmemoryops.applicationModule;
...
public class AppModuleAMFixture {
    ...
    private AppModuleAMFixture() {
        _am = Configuration.createRootApplicationModule("devguide.advanced.inmemoryops.AppModule","AppModuleLocal");
    }
