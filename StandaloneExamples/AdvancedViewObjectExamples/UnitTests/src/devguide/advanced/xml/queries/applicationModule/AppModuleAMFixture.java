package devguide.advanced.xml.queries.applicationModule;
...
public class AppModuleAMFixture {
    ...
    private AppModuleAMFixture() {
        _am = Configuration.createRootApplicationModule("devguide.advanced.xml.queries.AppModule","AppModuleLocal");
    }
