package devguide.advanced.customerrors.applicationModule;
...
public class ProductModuleAMFixture {
    ...
    private ProductModuleAMFixture() {
        _am = Configuration.createRootApplicationModule("devguide.advanced.customerrors.ProductModule","ProductModuleLocal");
    }
