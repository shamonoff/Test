package oracle.fodemo.storefront.lookups.view.PersonTypesVO;
...
public class PersonTypesVOTest {
    ...
    public PersonTypesVOTest() {
    }

    @Test
    public void testAccess() {
        ViewObject view = _am.findViewObject("PersonTypes");
        assertNotNull(view);
    }
    ...
    public void testViewCriteria() {
        ...
        for (Row row : allRows) {
            ...
            assertEquals("LookupType should be PERSON_TYPE_CODE", "PERSON_TYPE_CODE", lookupTypeAttr);
        }
    }
