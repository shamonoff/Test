package oracle.fodemo.storefront.lookups.view.DiscountTypesVO;
...
public class DiscountTypesVOTest {
    ...
    public DiscountTypesVOTest() {
    }

    @Test
    public void testAccess() {
        ViewObject view = _am.findViewObject("DiscountTypes");
        assertNotNull(view);
    }
    ...
    public void testViewCriteria() {
        ...
        for (Row row : allRows) {
            ...
            assertEquals("LookupType should be DISCOUNT_TYPE_CODE", "DISCOUNT_TYPE_CODE", lookupTypeAttr);
        }
    }
