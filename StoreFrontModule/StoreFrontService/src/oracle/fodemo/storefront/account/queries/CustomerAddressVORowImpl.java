...
// ---------------------------------------------------------------------
public class CustomerAddressVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        AddressId {
            public Object get(CustomerAddressVORowImpl obj) {
                return obj.getAddressId();
            }

            public void put(CustomerAddressVORowImpl obj, Object value) {
        ...
        AddressId1 {
            ...
            public void put(CustomerAddressVORowImpl obj, Object value) {
                obj.setAddressId1((Number)value);
            }
        }
        ,
        UsageTypeCode {
        ...
        UsageTypeDescription {
            public Object get(CustomerAddressVORowImpl obj) {
                return obj.getUsageTypeDescription();
            }

            public void put(CustomerAddressVORowImpl obj, Object value) {
                obj.setUsageTypeDescription((String)value);
            }
        }
        ,
        ObjectVersionId2 {
         ...
         * @return
         */
        public abstract Object get(CustomerAddressVORowImpl object);

        /**
         * @param object
         * @param value
         */
        public abstract void put(CustomerAddressVORowImpl object,
                                 Object value);
    ...
    public static final int USAGETYPEDESCRIPTION = AttributesEnum.UsageTypeDescription.index();
     ...
     */
    public CustomerAddressVORowImpl() {
    }
    ...
    public AddressUsageEOImpl getAddressUsageEO() {
        return (AddressUsageEOImpl)getEntity(1);
    }
     ...
     * @return
     */
    public Number getAddressId1() {
        return (Number) getAttributeInternal(ADDRESSID1);
    }

    /**Sets <code>value</code> as attribute value for ADDRESS_ID using the alias name AddressId1.
     * @param value
     */
    public void setAddressId1(Number value) {
    ...
    /**Gets the attribute value for MEANING using the alias name UsageTypeDescription.
     * @return
     */
    public String getUsageTypeDescription() {
        return (String) getAttributeInternal(USAGETYPEDESCRIPTION);
    }

    /**
     * Sets <code>value</code> as attribute value for MEANING using the alias name UsageTypeDescription.
     * @param value value to set the MEANING
     */
    public void setUsageTypeDescription(String value) {
        setAttributeInternal(USAGETYPEDESCRIPTION, value);
    }
}
